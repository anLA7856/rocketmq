...
public class SubscriptionData implements Comparable<SubscriptionData> {
    ...
    private String subString;  // 消息过滤表达式，多个用双竖线隔开，例如“ TAGA l l TAGB ” 。
    private Set<String> tagsSet = new HashSet<String>();  // 消息过滤tag 集合，消费端过滤时进行消息过滤的依据。
    private Set<Integer> codeSet = new HashSet<Integer>();  // 消息过滤tag h ashcod巳集合。
    private long subVersion = System.currentTimeMillis();
    private String expressionType = ExpressionType.TAG;  // 过滤类型， TAG 或SQL92 。
